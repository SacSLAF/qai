...
$stmt = $db->prepare("SELECT d.id, d.title, d.description, d.uploaded_at, d.file_path 
    ...
    WHERE d.publication_category_id = 5 AND d.is_active = 1
    ...
    <main class="container my-5 pt-5">
        ...
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="publication.php" >Publications</a></li>
                <li class="breadcrumb-item active" aria-current="page">Technical Library</li>
            </ol>
        </nav>
