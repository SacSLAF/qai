    ...
    <!-- Breadcrumb Navigation -->
        ...
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="osh.php">Occupational Safety & Health</a></li>
                <li class="breadcrumb-item active" aria-current="page">Audit Checklist</li>
            </ol>
        </nav>

        <div class="page-header mb-4">
            <h3 class="colour-defult">Audit Checklist<i class="fa fa-tasks"></i>
                <!--<div class="float-end">
                ...
                <div class="row text-center " style="justify-content: center;">
                    ...
                    <div class="col-md-3 col-sm-2 mb-4" style="height: 100px;">
                        <a href="ae.php" class="card-link text-decoration-none w-100">
                    ...
                    <div class="col-md-3 col-sm-2 mb-4 ">
                        <a href="ao.php" class="card-link text-decoration-none w-100">
                            <div class="card hover-effect border border-2 border-primary bg-white h-100" style=" width: 250px;">
                                <div class="card-body text-center p-4">
                    ...
                    <div class="col-md-3 col-sm-2 mb-4">
                        <a href="ce.php" class="card-link text-decoration-none w-100">
                            <div class="card hover-effect border border-2 border-primary bg-white h-100" style=" width: 250px;">
                                <div class="card-body text-center p-4">
                    ...
                    <div class="col-md-3 col-sm-2 mb-4">
                        <a href="ee.php" class="card-link text-decoration-none w-100">
                            <div class="card hover-effect border border-2 border-primary bg-white h-100" style=" width: 250px;">
                                <div class="card-body text-center p-4">
                    ...
                    <div class="col-md-3 col-sm-2 mb-4">
                        <a href="ge.php" class="card-link text-decoration-none w-100" >
                            <div class="card hover-effect border border-2 border-primary bg-white h-100" style=" width: 250px;">
                                <div class="card-body text-center p-4">
                    ...
                    <!-- Technical Library Card -->
                    <div class="col-md-3 col-sm-2 mb-4">
                        <a href="go.php" class="card-link text-decoration-none w-100">
                            <div class="card hover-effect border border-2 border-primary bg-white h-100" style=" width: 250px;">
                                <div class="card-body text-center p-4">
                                    <!--<i class="fas fa-book-open fs-1 text-primary mb-3"></i>-->
                    ...
                    <!-- Technical Library Card -->
                    <div class="col-md-3 col-sm-2 mb-4">
                        <a href="pm.php" class="card-link text-decoration-none w-100">
                            <div class="card hover-effect border border-2 border-primary bg-white h-100" style=" width: 250px;">
                                <div class="card-body text-center p-4">
                                    <!--<i class="fas fa-book-open fs-1 text-primary mb-3"></i>-->
                    ...
                    <!-- Technical Library Card -->
                    <div class="col-md-3 col-sm-2 mb-4" style="height: 100px;">
                        <a href="t.php" class="card-link text-decoration-none w-100">
                            <div class="card hover-effect border border-2 border-primary bg-white h-100" style=" width: 250px;">
                                <div class="card-body text-center p-4">
                                    <!--<i class="fas fa-book-open fs-1 text-primary mb-3"></i>-->
