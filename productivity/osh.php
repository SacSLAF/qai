    ...
    <!-- Breadcrumb Navigation -->
        ...
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page">Occupational Safety & Health</li>
            </ol>
        </nav>

        <div class="page-header mb-4">
            <h3 class="colour-defult">Occupational Safety & Health<i class="fa fa-tasks"></i>
                <!--<div class="float-end">
                ...
                <div class="row text-center " style="justify-content: center;">
                    ...
                    <div class="col-md-3 col-sm-2 mb-4" style="height: 100px;">
                        <a href="osh_manual.php" class="card-link text-decoration-none w-100">
                            <div class="card hover-effect border border-2 border-primary bg-white h-100" style=" width: 250px;">
                                ...
                                <!-- <i class="fas fa-globe fs-1 text-primary mb-3"></i>-->
                                    <h5 class="mb-0 text-dark fw-semibold">OSH Manual</h5>
                                </div>
                            </div>
                        </a>
                    </div>
                    ...
                    <div class="col-md-3 col-sm-2 mb-4 ">
                        <a href="osh-plan.php" class="card-link text-decoration-none w-100">
                            <div class="card hover-effect border border-2 border-primary bg-white h-100" style=" width: 250px;">
                                <div class="card-body text-center p-4">
                                    <!-- <i class="fas fa-file-alt fs-1 text-primary mb-3"></i>-->
                                <h5 class="mb-0 text-dark fw-semibold">Audit Plan</h5>
                                </div>
                            </div>
                        </a>
                    </div>
                    ...
                    <div class="col-md-3 col-sm-2 mb-4">
                        <a href="osh-check.php" class="card-link text-decoration-none w-100">
                            <div class="card hover-effect border border-2 border-primary bg-white h-100" style=" width: 250px;">
                                <div class="card-body text-center p-4">
                                <!-- <i class="fas fa-newspaper fs-1 text-primary mb-3"></i>-->
                                    <h5 class="mb-0 text-dark fw-semibold">Audit Checklist</h5>
                                </div>
                            </div>
                        </a>
                    </div>
                    ...
                    <div class="col-md-3 col-sm-2 mb-4">
                        <a href="osh-report.php" class="card-link text-decoration-none w-100">
                            <div class="card hover-effect border border-2 border-primary bg-white h-100" style=" width: 250px;">
                                <div class="card-body text-center p-4">
                                    <!--<i class="fas fa-cogs fs-1 text-primary mb-3"></i>-->
                                    <h5 class="mb-0 text-dark fw-semibold">Audit Report</h5>
                                </div>
                            </div>
                        </a>
