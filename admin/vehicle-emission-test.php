                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header d-flex justify-content-between align-items-center">
                                <h4 class="card-title">LIST OF DIESEL VEHICLES SUBJECTED TO VEHICLE EMISSION TEST-2024</h4>
                            ...
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table id="vehicleEmissionTable" class="display min-w850 table table-striped table-hover">
                                        <thead>
                                            <tr>
                                                <th>S/No</th>
                                                <th>Camp</th>
