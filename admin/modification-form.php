...
if (isset($_GET['id'])) {
    $id = (int)$_GET['id'];
    $stmt = $db->prepare("SELECT * FROM modification WHERE id = ?");
...
<head>
    ...
    <title><?= isset($record) ? 'Edit' : 'Add' ?> Modification Record</title>
</head>
<body>
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header d-flex justify-content-between align-items-center">
                            <h4 class="card-title"><?= isset($record) ? 'Edit' : 'Add' ?> Modification Record</h4>
                            <a href="modification.php" class="btn btn-sm btn-outline-secondary">
                        ...
                        <div class="card-body">
                            ...
                            <form action="action/modification-save.php" method="post">
                                <?php if (isset($record)): ?>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-12 mb-4">
                                        ...
                                        <div class="row">
                                            <div class="col-md-4">
                                                <div class="mb-3">
                                                    <label class="form-label">MOD Number</label>
                                                    <input type="text" name="mod_no" class="form-control" value="<?= isset($record) ? htmlspecialchars($record['mod_no']) : '' ?>">
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                <div class="mb-3">
                                            ...
                                            <div class="col-md-4">
                                                <div class="mb-3">
                                                    <label class="form-label">Recommended Date</label>
                                                    <input type="date" name="recommended_date" class="form-control" value="<?= isset($record) ? $record['recommended_date'] : '' ?>">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
