...
// Fetch all Maintenance Program records with joins
$records = [];
$res = $db->query("
...
if ($res !== false) {
    ...
    error_log('Error fetching Maintenance Program records: ' . $db->error);
    $records = [];
}
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header d-flex justify-content-between align-items-center">
                                <h4 class="card-title">Maintenance Program</h4>
                                <a href="maintenance-program-form.php" class="btn btn-sm btn-outline-primary">
                            ...
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table id="maintenanceProgramTable" class="display min-w850 table table-striped table-hover">
                                        <thead>
                                            <tr>
                                                <th>Doc Type</th>
                                        ...
                                        <tbody>
                                            ...
                                            <?php else: ?>
                                                <?php foreach ($records as $r): ?>
                                                    <tr>
                                                        <td>
                                                            <span class="badge badge-<?= $r['document_type'] == 'worksheet' ? 'primary' : 'success' ?>">
                                                                <?= ucfirst($r['document_type']) ?>
                                                            </span>
                                                        </td>
                                                        <td><?= htmlspecialchars($r['document_number']) ?></td>
                                                        ...
                                                        <td>
                                                            <div class="d-flex">
                                                                <a href="edit-maintenance-program.php?id=<?= $r['id'] ?>" class="btn btn-sm btn-outline-secondary">
                                                                    <i class="fas fa-edit"></i> Edit
                                                                </a>

                                                                <form action="action/maintenance-program-delete.php" method="post" style="display:inline-block;" onsubmit="return confirm('Are you sure you want to delete this document?');">
