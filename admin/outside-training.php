...
// Fetch all Outside Training records with joins
$records = [];
$res = $db->query("
...
if ($res !== false) {
    ...
    error_log('Error fetching Outside Training records: ' . $db->error);
    $records = [];
}
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header d-flex justify-content-between align-items-center">
                                <h4 class="card-title">Outside Training Management</h4>
                                <a href="outside-training-form.php" class="btn btn-sm btn-outline-primary">
                            ...
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table id="outsideTrainingTable" class="display min-w850 table table-striped table-hover">
                                        <thead>
                                            <tr>
                                                <th>S/NO</th>
                                                <th>Description</th>
                                            ...
                                            <?php else: ?>
                                                <?php foreach ($records as $r): ?>
                                                    <tr>
                                                        ...
                                                        <td><?= htmlspecialchars($r['conducted_institute'] ?? 'N/A') ?></td>
                                                        ...
                                                        <td>
                                                            <div class="d-flex">
                                                                <a href="edit-outside-training.php?id=<?= $r['id'] ?>" class="btn btn-sm btn-outline-secondary">
                                                                    <i class="fas fa-edit"></i> Edit
                                                                </a>

                                                                <form action="action/outside-training-delete.php" method="post" style="display:inline-block;" onsubmit="return confirm('Are you sure you want to delete this training record?');">
