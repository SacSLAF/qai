...
$stmt = $db->prepare("SELECT d.id, d.title, d.description, d.uploaded_at, d.file_path 
    ...
    WHERE d.training_category_id = 1 AND d.is_active = 1 AND d.branch_id = ?
...
<head>
    ...
    <title>Training Documents - Approved Training Syllabus</title>
...
<body>
    ...
    <main class="container my-5 pt-5">
        <div class="page-header mb-4">
            <h3 class="colour-defult">Approved Training Syllabus<i class="fa fa-tasks"></i>
                <div class="float-end">
