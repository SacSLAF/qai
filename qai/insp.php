        ...
        <div class="row">
            ...
            <div class="col-lg-9 col-xl-10">
                <div class="tab-content" id="inspectorateTabsContent">
                    ...
                    <!-- About Us -->
                    <div class="tab-pane fade content-loaded" id="org" role="tabpanel" style="color:#1a4f72;">
                    ...
                    <!-- Policy -->
                    <div class="tab-pane fade content-loaded" id="functions" role="tabpanel">
                        <div class="tab-pane-content">
                    ...
                    <!-- Structure -->
                    <div class="tab-pane fade content-loaded" id="structure" role="tabpanel">
                        <div class="tab-pane-content">
                    ...
                    <!-- Staff -->
                    <div class="tab-pane fade content-loaded" id="responsibilities" role="tabpanel">
                        <div class="tab-pane-content">
                            <!-- Director -->
                            <div class="mb-5">
                    ...
                    <!-- History -->
                    <div class="tab-pane fade content-loaded" id="history" role="tabpanel" style="color:#1a4f72;">
                        <div class="tab-pane-content">
                    ...
                    <!-- Achievements -->
                    <div class="tab-pane fade content-loaded" id="achievements" role="tabpanel">
                        <div class="tab-pane-content">
                            <div class="row justify-content-center">
                                <!-- Card 1 -->
