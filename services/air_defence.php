    ...
    <main class="container my-5 pt-5">
        ...
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active">Air Defence Radar Squadron</li>
            </ol>
        </nav>

        <div class="page-header mb-4">
            <h3 class="colour-defult">Air Defence Radar Squadron<i class="fas fa-book"></i>
               <!-- <div class="float-end">
                    ...
                    <div class="card hover-effect border border-2 border-primary bg-white h-100" style=" width: 250px;">
                        <div class="card-body text-center p-4">
                           <!-- <i class="fas fa-globe fs-1 text-primary mb-3"></i>-->
                            <h5 class="mb-0 text-dark fw-semibold">No. 01 ADRS</h5>
                        </div>
                    </div>
                </a>
            </div>
                ...
                <a href="ad_bulletins.php" class="card-link text-decoration-none w-100">
                    <div class="card hover-effect border border-2 border-primary bg-white h-100" style=" width: 250px;">
                        <div class="card-body text-center p-4">
                           ...
                           <h5 class="mb-0 text-dark fw-semibold">No. 02 ADRS</h5>
                        </div>
                    </div>
                </a>
            </div>
                    ...
                    <div class="card hover-effect border border-2 border-primary bg-white h-100" style=" width: 250px;">
                        <div class="card-body text-center p-4">
                           <!-- <i class="fas fa-newspaper fs-1 text-primary mb-3"></i>-->
                            <h5 class="mb-0 text-dark fw-semibold">No. 03 ADRS</h5>
                        </div>
                    </div>
                </a>
            </div>
                ...
                <a href="maintenace.php" class="card-link text-decoration-none w-100">
                    <div class="card hover-effect border border-2 border-primary bg-white h-100" style=" width: 250px;">
                        <div class="card-body text-center p-4">
                            ...
                            <h5 class="mb-0 text-dark fw-semibold">No.04 ADRS</h5>
                        </div>
                    </div>
                </a>
            </div>
                ...
                <a href="tech_lib.php" class="card-link text-decoration-none w-100" >
                    <div class="card hover-effect border border-2 border-primary bg-white h-100" style=" width: 250px;">
                        <div class="card-body text-center p-4">
                            ...
                            <h5 class="mb-0 text-dark fw-semibold">No.05 ADRS</h5>
                        </div>
                    </div>
                </a>
            </div>
            ...
            <div class="col-md-3 col-sm-2 mb-4">
                <a href="tech_lib.php" class="card-link text-decoration-none w-100">
                    <div class="card hover-effect border border-2 border-primary bg-white h-100" style=" width: 250px;">
                        <div class="card-body text-center p-4">
                            <!--<i class="fas fa-book-open fs-1 text-primary mb-3"></i>-->
                            <h5 class="mb-0 text-dark fw-semibold">No.06 ADRS</h5>
                        </div>
                    </div>
                </a>
            </div>
            ...
            <div class="col-md-3 col-sm-2 mb-4" style="height: 80px;">
                <a href="tech_lib.php" class="card-link text-decoration-none w-100">
                    <div class="card hover-effect border border-2 border-primary bg-white h-100" style=" width: 250px;">
                        <div class="card-body text-center p-4">
                            <!--<i class="fas fa-book-open fs-1 text-primary mb-3"></i>-->
                            <h5 class="mb-0 text-dark fw-semibold">No.07 ADRS</h5>
                        </div>
                    </div>
                </a>
            </div>
