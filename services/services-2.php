...
<head>
    ...
    <style>
        ...
        .content-loaded .tab-pane-content {
            padding: 20px 0;
        }
    </style>
</head>
        ...
        <div class="main-container">
            ...
            <div class="nav-column">
                <div class="nav flex-column nav-pills" id="inspectorateTabs" role="tablist">
                    ...
                    <div class="qa-dropdown">
                        <a class="nav-link qa-dropdown-toggle" href="#" role="button">QA Audits</a>
                        <div class="qa-dropdown-menu">
                            <a class="qa-dropdown-item" href="#" data-bs-target="#audits_plan" role="tab">Audits Plan</a>
                            <a class="qa-dropdown-item" href="#" data-bs-target="#audit_check_list" role="tab">Audit Check List</a>
                            <a class="qa-dropdown-item" href="#" data-bs-target="#qa_report" role="tab">QA Report</a>
                        </div>
                    </div>
                    <!-- Aircraft Competency Dropdown -->
                    <div class="qa-dropdown">
                        <a class="nav-link qa-dropdown-toggle" href="#" role="button">Aircraft Competency</a>
                        <div class="qa-dropdown-menu">
                            <a class="qa-dropdown-item" href="#" data-bs-target="#ac_cmpt_1" role="tab">AE</a>
                            <a class="qa-dropdown-item" href="#" data-bs-target="#ac_cmpt_5" role="tab">GE</a>
                            <a class="qa-dropdown-item" href="#" data-bs-target="#ac_cmpt_4" role="tab">EE</a>
                        </div>
                    </div>
                    <a class="nav-link" href="#" data-bs-target="#latitude" role="tab">Latitude & Extensions</a>
                    <!-- Modification / R&D Dropdown -->
                    <div class="qa-dropdown">
                        <a class="nav-link qa-dropdown-toggle" href="#" role="button">Modifications / R&D</a>
                        <div class="qa-dropdown-menu">
                            <a class="qa-dropdown-item" href="#" data-bs-target="#modification" role="tab">Modifications</a>
                            <a class="qa-dropdown-item" href="#" data-bs-target="#rnd" role="tab">R&D</a>
                        </div>
                    </div>

                    <!-- Vehicle Emission Test Dropdown -->
                    <div class="qa-dropdown">
                        <a class="nav-link qa-dropdown-toggle" href="#" role="button">Vehicle Emission Test</a>
                        <div class="qa-dropdown-menu">
                            <a class="qa-dropdown-item" href="#" data-bs-target="#vehicle_annual_plans" role="tab">Annual Plans</a>
                            <a class="qa-dropdown-item" href="#" data-bs-target="#vehicle_test_reports" role="tab">Test Reports</a>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="content-column">
                <div class="tab-content" id="inspectorateTabsContent">
                    ...
                    <div class="tab-pane fade content-loaded" id="audits_plan" role="tabpanel">
                    ...
                    <div class="tab-pane fade content-loaded" id="audit_check_list" role="tabpanel">
                        <div class="tab-pane-content">
                    ...
                    <div class="tab-pane fade content-loaded" id="qa_report" role="tabpanel">
                        <div class="tab-pane-content">
                    ...
                    <?php foreach ($branch_mappings as $branch_id => $branch_name): ?>
                        <div class="tab-pane fade content-loaded" id="ac_cmpt_<?= $branch_id ?>" role="tabpanel">
                            <div class="tab-pane-content">
                    ...
                    <div class="tab-pane fade content-loaded" id="latitude" role="tabpanel">
                        <div class="tab-pane-content">
                    ...
                    <div class="tab-pane fade content-loaded" id="modification" role="tabpanel">
                        <div class="tab-pane-content">
                    ...
                    <div class="tab-pane fade content-loaded" id="rnd" role="tabpanel">
                        <div class="tab-pane-content">
                    ...
                    <div class="tab-pane fade content-loaded" id="vehicle_annual_plans" role="tabpanel">
                        <div class="tab-pane-content">
                    ...
                    <div class="tab-pane fade content-loaded" id="vehicle_test_reports" role="tabpanel">
                        <div class="tab-pane-content">
