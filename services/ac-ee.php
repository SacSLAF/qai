    ...
    <!-- Breadcrumb Navigation -->
        ...
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="aircraft_competency.php">Aircraft Competency</a></li>
                <li class="breadcrumb-item active" aria-current="page">Electronic Engineering</li>
            </ol>
        </nav>

        <div class="page-header mb-4">
            <h3 class="colour-defult">Electronic Engineering<i class="fa fa-tasks"></i>
                <!--<div class="float-end">
                ...
                <div class="row text-center " style="justify-content: center;">
                    ...
                    <div class="col-md-2 mb-4" >
                        <a href="ac-ee-aircraft_type.php" class="card-link text-decoration-none w-100">
                            <div class="card hover-effect border border-2 border-primary bg-white h-100" style="height: 110px; width: 210px;">
                                <div class="card-body text-center p-4">
                                <!-- <i class="fas fa-globe fs-1 text-primary mb-3"></i>-->
                                    <h5 class="mb-0 text-dark fw-semibold">Air Craft</h5>
                                </div>
                            </div>
                        </a>
                    </div>
                    ...
                    <div class="col-md-2 mb-4">
                        <a href="ac-ee-cs.php" class="card-link text-decoration-none w-100">
                            <div class="card hover-effect border border-2 border-primary bg-white h-100" style="height: 110px; width: 210px;">
                                <div class="card-body text-center p-4">
                                    <!--<i class="fas fa-cogs fs-1 text-primary mb-3"></i>-->
                                    <h5 class="mb-0 text-dark fw-semibold">Communication System</h5>
                                </div>
                            </div>
                        </a>
                    </div>
                    ...
                    <div class="col-md-2 mb-4">
                        <a href="ac-ee-ns.php" class="card-link text-decoration-none w-100" >
                            <div class="card hover-effect border border-2 border-primary bg-white h-100" style="height: 110px; width: 210px;">
                                <div class="card-body text-center p-4">
                                    <!--<i class="fas fa-book-open fs-1 text-primary mb-3"></i>-->
                                    <h5 class="mb-0 text-dark fw-semibold">Navigation System</h5>
                                </div>
                            </div>
                        </a>
                    </div>
                    ...
                    <!-- Technical Library Card -->
                    <div class="col-md-2 mb-4">
                        <a href="ac-ee-n&r.php" class="card-link text-decoration-none w-100" >
                            <div class="card hover-effect border border-2 border-primary bg-white h-100" style="height: 110px; width: 210px;">
                                <div class="card-body text-center p-4">
                                    <!--<i class="fas fa-book-open fs-1 text-primary mb-3"></i>-->
                                    <h5 class="mb-0 text-dark fw-semibold">Navigation & Radar System</h5>
                                </div>
                            </div>
                        </a>
                    </div>
                    ...
                    <!-- Technical Library Card -->
                    <div class="col-md-2 mb-4">
                        <a href="ac-ee-rs.php" class="card-link text-decoration-none w-100" >
                            <div class="card hover-effect border border-2 border-primary bg-white h-100" style="height: 110px; width: 210px;">
                                <div class="card-body text-center p-4">
                                    <!--<i class="fas fa-book-open fs-1 text-primary mb-3"></i>-->
